...
import (
	...
	"github.com/ejunjsh/goproxy/socks5"
	"github.com/ejunjsh/goproxy/socks4"
)
...
func main(){
	...
	case "socks5":
		p=&socks5.Proxy{tcp.Proxy{ProxyAdr: proxyAdr}}
	case "socks4":
		p=&socks4.Proxy{tcp.Proxy{ProxyAdr: proxyAdr}}
	case "https":
